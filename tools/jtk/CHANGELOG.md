...
- `issues history <issue-key>` lists Jira changelog history with compact changed-field rows, `--id`, `--extended`, `--fields`, and offset pagination support. ([#420](https://github.com/open-cli-collective/atlassian-cli/issues/420))
